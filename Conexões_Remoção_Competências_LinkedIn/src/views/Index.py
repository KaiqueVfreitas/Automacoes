...
class Index:
     def __init__(self): 
          ...
          btn_login = ctk.CTkButton(
               janela, 
               text="ENTRAR", 
               command=self.metodo_receber_email_e_senha, 
               width=300, 
               corner_radius=8, 
     ...
     def metodo_receber_email_e_senha(self):
          email = txt_email.get()
          senha = txt_senha.get()
          
          LinkedinController.metodo_login_linkedin(email, senha)
          
               # Método para receber os valores digitados no CTkEntry e compartilhar nas controllers
